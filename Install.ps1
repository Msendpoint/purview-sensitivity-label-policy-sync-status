<#
.SYNOPSIS
    One-click installer and launcher for Monitor Sensitivity Label Policy Sync Status in Microsoft Purview
...
Write-Host "    Monitor Sensitivity Label Policy Sync Status in Microsoft Purview" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/purview-sensitivity-label-policy-sync-status.ps1"
